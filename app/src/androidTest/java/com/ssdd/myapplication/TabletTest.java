...
import com.ssdd.myapplication.MainActivity;
...
public class TabletTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testRun() {
		...
		solo.waitForActivity(com.ssdd.myapplication.MainActivity.class, delay);
		...
		assertTrue("'feed_view' was not found!", solo.waitForView(solo
				.getView(com.ssdd.myapplication.R.id.feed_view)));
